...
const track_search = '&page=1&page_size=10&f_has_lyrics=1&&s_track-rating=desc'
...
export const trackSearch = q_track => `${cors_anywhere}${encodeURIComponent(`${base_url}${name_api_key}${api_key}${track_search}${q_track}${track_search_params}`)}`
